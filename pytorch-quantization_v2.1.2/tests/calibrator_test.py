...
class TestMaxCalibrator():
    ...
    def test_simple_run(self):
        ...
        x_1 = torch.rand(9).cuda()# 129 
        x_2 = torch.rand(7).cuda()# 127
        max_calibrator.collect(x_1)
        max_calibrator.collect(x_2)
        print(x_1)
        print(x_2)
        print(x_1.max(), x_2.max())
        
        print(max_calibrator.compute_amax())
    ...
    def test_fine_grain(self):
        ...
        print(max_calibrator.compute_amax().shape)
        print(x_1.max(), x_2.max())
