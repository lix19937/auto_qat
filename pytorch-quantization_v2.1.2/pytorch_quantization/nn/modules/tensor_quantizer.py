...
class TensorQuantizer(nn.Module):
    ...
    def _fb_fake_quant(self, inputs, amax):
        ...
        if amax.numel() == 1:
            ...
            if "1.8.0" in torch.__version__: ##  RTX3070 1.8.0+cu111
    ...
    def _quant_forward(self, inputs):
        ...
        if self._fake_quant:
            if not TensorQuantizer.use_fb_fake_quant: ###  here use nv fake_quant
                ...
                outputs = self._fb_fake_quant(inputs, amax) ###  here use fb fake_quant
        else:
