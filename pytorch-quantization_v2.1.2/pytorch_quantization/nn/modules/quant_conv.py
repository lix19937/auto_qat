...
__all__ = [
    ...
    "ConvTranspose3d", "QuantConvTranspose1d", "QuantConvTranspose2d", "QuantConvTranspose3d", "QuantConv2d_WeightOnly"
]
...
class QuantConv2d_WeightOnly(_QuantConvNd):
    """Quantized 2D conv"""
    ...
    def __init__(self,
        ...
        quant_desc_input, quant_desc_weight = _utils.pop_quant_desc_in_kwargs(self.__class__, **kwargs)
        super(QuantConv2d_WeightOnly, self).__init__(in_channels, out_channels, kernel_size, stride, padding, dilation, False,
                                          _pair(0), groups, bias, padding_mode,
                                          quant_desc_input=quant_desc_input, quant_desc_weight=quant_desc_weight)
